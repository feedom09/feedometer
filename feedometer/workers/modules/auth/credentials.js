...
export async function handleRegister(request, env) {
  ...
  try {
    ...
    const verifyUrl = (env.APP_PUBLIC_URL || env.PAGES_URL || 'https://feedometer-iyo.pages.dev') +
...
export async function handleForgotPassword(request, env) {
  ...
  try {
    ...
    const resetUrl = (env.APP_PUBLIC_URL || env.PAGES_URL || 'https://feedometer-iyo.pages.dev') +
